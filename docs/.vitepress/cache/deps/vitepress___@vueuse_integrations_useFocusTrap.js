import {
    ...
    tryOnScopeDispose,
    unrefElement,
} from "./chunk-5UB6MTCB.js";
import { computed, shallowRef, toValue, watch } from "./chunk-QHC3C7AY.js";
...
var isValidShadowRootTabbable = function isValidShadowRootTabbable2(
    ...
    var tabIndex = Number.parseInt(shadowHostNode.getAttribute("tabindex"), 10);
...
function ownKeys(e, r) {
    ...
    if (Object.getOwnPropertySymbols) {
        ...
        r &&
            (o = o.filter(
                (r2) => Object.getOwnPropertyDescriptor(e, r2).enumerable,
            )),
            t.push.apply(t, o);
    }
    return t;
...
var createFocusTrap = function createFocusTrap2(elements, userOptions) {
        ...
        state.containerGroups = state.containers.map((container) => {
            ...
            var lastTabbableNode =
                tabbableNodes.length > 0
                    ...
                    : void 0;
            var firstDomTabbableNode = focusableNodes.find((node) =>
                isTabbable(node),
            );
    ...
    var checkDomRemoval = function checkDomRemoval2(mutations) {
        var isFocusedNodeRemoved = mutations.some((mutation) => {
...
// ../node_modules/.pnpm/@vueuse+integrations@12.8.2_focus-trap@7.6.4_typescript@5.8.3/node_modules/@vueuse/integrations/useFocusTrap.mjs
