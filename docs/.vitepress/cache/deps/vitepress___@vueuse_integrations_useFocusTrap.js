...
import {computed, shallowRef, toValue, watch} from './chunk-CFSAUIOU.js';
...
var getCandidatesIteratively = function getCandidatesIteratively2(
        ...
        while (elementsToCheck.length) {
                ...
                if (element.tagName === 'SLOT') {
                        ...
                        var validCandidate = matches.call(
                                element,
                                candidateSelector,
                        );
                        if (
...
var sortByOrder = function sortByOrder2(candidates) {
        ...
        candidates.forEach(function (item, i) {
                ...
                var elements = isScope
                        ? sortByOrder2(item.candidates)
                        : element;
                if (candidateTabindex === 0) {
                        isScope
                                ? regularTabbables.push.apply(
                                          regularTabbables,
                                          elements,
                                  )
...
var tabbable = function tabbable2(container, options) {
        ...
        if (options.getShadowRoot) {
                candidates = getCandidatesIteratively(
                        ...
                        {
                                filter: isNodeMatchingSelectorTabbable.bind(
                                        null,
                                        options,
                                ),
                                flatten: false,
...
var focusable = function focusable2(container, options) {
        ...
        if (options.getShadowRoot) {
                candidates = getCandidatesIteratively(
                        ...
                        options.includeContainer,
                        {
                                filter: isNodeMatchingSelectorFocusable.bind(
                                        null,
                                        options,
                                ),
                                flatten: true,
        ...
        if (Object.getOwnPropertySymbols) {
                ...
                r &&
                        (o = o.filter(function (r2) {
                                return Object.getOwnPropertyDescriptor(e, r2)
                                        .enumerable;
                        })),
                        t.push.apply(t, o);
        }
...
var createFocusTrap = function createFocusTrap2(elements, userOptions) {
        ...
        var getInitialFocusNode = function getInitialFocusNode2() {
                ...
                if (
                        ...
                        if (findContainerIndex(doc.activeElement) >= 0) {
                                ...
                                var firstTabbableGroup =
                                        state.tabbableGroups[0];
                ...
                state.containerGroups = state.containers.map(
                        function (container) {
                                ...
                                var lastTabbableNode =
                                        tabbableNodes.length > 0
                                                ? tabbableNodes[
                                                          tabbableNodes.length -
                                                                  1
                                                  ]
                                                : void 0;
                                var firstDomTabbableNode = focusableNodes.find(
                                        function (node) {
                                ...
                                var posTabIndexesFound = !!tabbableNodes.find(
                                        function (node) {
                ...
                if (state.tabbableGroups.length > 0) {
                        ...
                        if (containerIndex < 0) {
                                ...
                                var startOfGroupIndex =
                                        state.tabbableGroups.findIndex(
                                                function (_ref4) {
                                                        var firstTabbableNode =
                                                                _ref4.firstTabbableNode;
                                                        return (
                                                                target ===
                                                                firstTabbableNode
                                                        );
                ...
                if (targetContained || target instanceof Document) {
                        ...
                        if (state.mostRecentlyFocusedNode) {
                                if (
                                        ...
                                        if (
                                                !state.containerGroups.some(
                                                        function (g) {
                                                                return g.tabbableNodes.some(
                                                                        function (
                                                                                n,
                                                                        ) {
                                                                                return (
                        ...
                        if (navAcrossContainers) {
                                nextNode = findNextNavNode({
                                        ...
                                        isBackward: config.isKeyBackward(
                                                state.recentNavEvent,
                                        ),
                                });
                        }
        ...
        var checkEscapeKey = function checkEscapeKey2(event) {
                if (
                        isEscapeEvent(event) &&
                        valueOrHandler(config.escapeDeactivates, event) !==
                                false
                ) {
                        event.preventDefault();
                        trap.deactivate();
        ...
        trap = {
                ...
                deactivate: function deactivate(deactivateOptions) {
                        ...
                        var options = _objectSpread2(
                                {
                                        ...
                                        onPostDeactivate:
                                                config.onPostDeactivate,
                                        checkCanReturnFocus:
                                                config.checkCanReturnFocus,
                                },
                                deactivateOptions,
                        );
                        ...
                        onDeactivate === null ||
                                onDeactivate === void 0 ||
                                onDeactivate();
                        var finishDeactivation =
                                function finishDeactivation2() {
                                        delay(function () {
                                                if (returnFocus) {
                                                        _tryFocus(
                                                                getReturnFocusNode(
                ...
                updateContainerElements: function updateContainerElements(
                        ...
                        var elementsAsArray = []
                                ...
                                .filter(Boolean);
                        state.containers = elementsAsArray.map(
                                function (element) {
        ...
        Object.defineProperties(trap, {
                ...
                _setPausedState: {
                        value: function value(paused, options) {
                                ...
                                state.paused = paused;
                                if (paused) {
                                        var onPause = getOption(
                                                options,
                                                'onPause',
                                        );
                                        var onPostPause = getOption(
                                                options,
                                                'onPostPause',
                                        );
                                        onPause === null ||
                                        ...
                                        var onUnpause = getOption(
                                                options,
                                                'onUnpause',
                                        );
                                        var onPostUnpause = getOption(
                                                options,
                                                'onPostUnpause',
                                        );
                                        onUnpause === null ||
...
// ../node_modules/.pnpm/@vueuse+integrations@12.8.2_focus-trap@7.6.4_typescript@5.8.2/node_modules/@vueuse/integrations/useFocusTrap.mjs
