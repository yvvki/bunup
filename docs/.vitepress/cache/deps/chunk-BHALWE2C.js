...
function syncRefs(source, targets, options = {}) {
      ...
      return watch(
            source,
            newValue =>
                  targetsArray.forEach(target => (target.value = newValue)),
            {flush, deep, immediate},
      );
}
      ...
      for (const key in objectRef.value) {
            result[key] = customRef(() => ({
                  ...
                  set(v) {
                        var _a;
                        const replaceRef =
                              (_a = toValue(options.replaceRef)) != null
                                    ? _a
                                    : true;
                        if (replaceRef) {
...
function createUntil(r, isNot = false) {
      ...
      function toContains(value, options) {
            return toMatch(v => {
                  ...
                  return (
                        array.includes(value) || array.includes(toValue(value))
                  );
            }, options);
      }
      ...
      if (symmetric) {
            const diff2 = computed(() =>
                  toValue(values).filter(
                        x =>
                              toValue(list).findIndex(y => compareFn(x, y)) ===
                              -1,
                  ),
            );
            return computed(() =>
...
function createTemplatePromise(options = {}) {
      ...
      const component = defineComponent((_, {slots}) => {
            ...
            if (options.transition)
                  return () =>
                        h(TransitionGroup, options.transition, renderList);
            return renderList;
      });
      ...
      const stopWatch = watchImmediate(
            () => {
                  ...
                  return [
                        ...
                        toArray(
                              toValue(
                                    firstParamTargets.value ? args[1] : args[0],
                              ),
                        ),
                        toArray(
                              unref(
                                    firstParamTargets.value ? args[2] : args[1],
                              ),
                        ),
...
function onLongPress(target, handler, options) {
      ...
      function onMove(ev) {
            ...
            if (
                  !posStart ||
                  (options == null ? void 0 : options.distanceThreshold) ===
                        false
            )
                  return;
            if (
...
function useBrowserLocation(options = {}) {
      ...
      const buildState = trigger => {
            ...
            for (const key of WRITABLE_PROPERTIES)
                  refs[key].value =
                        (_a = window2 == null ? void 0 : window2.location) ==
                        null
                              ? void 0
                              : _a[key];
            return reactive({
      ...
      const updateHTMLAttrs = getSSRHandler(
            ...
            (selector2, attribute2, value) => {
                  ...
                  if (disableTransition) {
                        ...
                        style.appendChild(
                              document.createTextNode(CSS_DISABLE_TRANS),
                        );
      ...
      const intervalController = useIntervalFn(
            () => {
                  ...
                  if (remaining.value <= 0) {
                        ...
                        (_b2 = options == null ? void 0 : options.onComplete) ==
                        null
                              ? void 0
                              : _b2.call(options);
                  }
            ...
            {
                  immediate:
                        (_b = options == null ? void 0 : options.immediate) !=
                        null
                              ? _b
                              : false,
            },
            ...
            if (window2) {
                  const onDeviceMotion = createFilterWrapper(
                        ...
                        event => {
                              ...
                              acceleration.value = {
                                    x:
                                          ((_a = event.acceleration) == null
                                                ? void 0
                                                : _a.x) || null,
                                    y:
                                          ((_b = event.acceleration) == null
                                                ? void 0
                                                : _b.y) || null,
                                    z:
                                          ((_c = event.acceleration) == null
                                                ? void 0
                                                : _c.z) || null,
                              };
...
function useDisplayMedia(options = {}) {
      ...
      const isSupported = useSupported(() => {
            var _a2;
            return (_a2 =
                  navigator2 == null ? void 0 : navigator2.mediaDevices) == null
                  ? void 0
                  : _a2.getDisplayMedia;
      });
...
function useFileSystemAccess(options = {}) {
      ...
      const fileLastModified = computed(() => {
            var _a, _b;
            return (_b =
                  (_a = file.value) == null ? void 0 : _a.lastModified) != null
                  ? _b
                  : 0;
      });
                        ...
                        (_c =
                              (_b =
                                    (_a = targetElement.value) == null
                                          ...
                                          : _a.matches) == null
                                    ? void 0
                                    : _b.call(_a, PSEUDO_CLASS_FOCUS_WITHIN)) !=
                        null
                              ? _c
                              : false);
            },
...
function useFullscreen(target, options = {}) {
      ...
      const isCurrentElementFullScreen = () => {
            if (fullscreenElementMethod)
                  return (
                        (document2 == null
                              ? void 0
                              : document2[fullscreenElementMethod]) ===
                        targetRef.value
                  );
            return false;
      };
      ...
      async function enter() {
            ...
            if (
                  requestMethod.value &&
                  (target2 == null ? void 0 : target2[requestMethod.value]) !=
                        null
            ) {
            ...
            stop = watch(
                  ...
                  () => {
                        ...
                        elementPositionX.value =
                              left +
                              (type === 'page' ? window2.pageXOffset : 0);
...
function usePointerSwipe(target, options = {}) {
      ...
      tryOnMounted(() => {
            ...
            if (disableTextSelect) {
                  (_d = (_c = targetRef.value) == null ? void 0 : _c.style) ==
                  null
                        ? void 0
                        : _d.setProperty('-webkit-user-select', 'none');
                  (_f = (_e = targetRef.value) == null ? void 0 : _e.style) ==
                  null
                        ? void 0
                        : _f.setProperty('-ms-user-select', 'none');
                  (_h = (_g = targetRef.value) == null ? void 0 : _g.style) ==
                  null
                        ? void 0
...
function useSorted(...args) {
      ...
      if (args.length === 2) {
            if (typeof args[1] === 'object') {
                  options = args[1];
                  compareFn =
                        (_a = options.compareFn) != null ? _a : defaultCompare;
            } else {
...
function useTextSelection(options = {}) {
      ...
      const text = computed(() => {
            var _a, _b;
            return (_b =
                  (_a = selection.value) == null ? void 0 : _a.toString()) !=
                  null
                  ? _b
                  : '';
      });
      ...
      if (isSupported.value) {
            ...
            whenever(
                  () =>
                        ...
                        (document2 == null
                              ? void 0
                              : document2.visibilityState) === 'visible' &&
                        requestedType.value,
                  type => {
