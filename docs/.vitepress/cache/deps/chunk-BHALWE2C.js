...
// ../node_modules/.pnpm/@vueuse+shared@12.8.2_typescript@5.8.2/node_modules/@vueuse/shared/index.mjs
...
function getIsIOS() {
        ...
        return (
                ...
                (/iP(?:ad|hone|od)/.test(window.navigator.userAgent) ||
                        (((_b = window == null ? void 0 : window.navigator) ==
                        null
                                ? void 0
                                : _b.maxTouchPoints) > 2 &&
                                /iPad|Macintosh/.test(
...
function debounceFilter(ms, options = {}) {
        ...
        const filter = invoke2 => {
                ...
                if (
                        duration <= 0 ||
                        (maxDuration !== void 0 && maxDuration <= 0)
                ) {
                        if (maxTimer) {
                ...
                return new Promise((resolve, reject) => {
                        lastRejector = options.rejectOnCancel
                                ? reject
                                : resolve;
                        lastInvoker = invoke2;
...
function throttleFilter(...args) {
        ...
        if (!isRef(args[0]) && typeof args[0] === 'object')
                ...
                [ms, trailing = true, leading = true, rejectOnCancel = false] =
                        args;
        const clear = () => {
                if (timer) {
                        clearTimeout(timer);
...
function useArrayIncludes(...args) {
        ...
        if (typeof comparator === 'string') {
                ...
                comparator = (element, value2) =>
                        element[key] === toValue(value2);
        }
        comparator =
                comparator != null
                        ? comparator
...
function useArrayUnique(list, compareFn) {
        return computed(() => {
                const resolvedList = toValue(list).map(element =>
                        toValue(element),
                );
                return compareFn
...
function useCounter(initialValue = 0, options = {}) {
        ...
        const inc = (delta = 1) =>
                (count.value = Math.max(
                        Math.min(max, count.value + delta),
                        min,
                ));
        const dec = (delta = 1) =>
                (count.value = Math.min(
                        Math.max(min, count.value - delta),
                        max,
                ));
...
// ../node_modules/.pnpm/@vueuse+core@12.8.2_typescript@5.8.2/node_modules/@vueuse/core/index.mjs
        ...
        const shouldIgnore = event => {
                return toValue(ignore).some(target2 => {
                        if (typeof target2 === 'string') {
                                return Array.from(
                                        window2.document.querySelectorAll(
                                                target2,
                                        ),
                                ).some(
                                        el =>
...
function onElementRemoval(target, callback, options = {}) {
        const {
                window: window2 = defaultWindow,
                document: document2 = window2 == null
                        ? void 0
                        : window2.document,
                flush = 'sync',
        } = options;
...
function onLongPress(target, handler, options) {
        ...
        function onRelease(ev) {
                ...
                if (
                        ...
                        return;
                if (
                        ((_a2 = options == null ? void 0 : options.modifiers) ==
                        null
                                ? void 0
                                : _a2.self) &&
                        ...
                        return;
                if (
                        (_b2 = options == null ? void 0 : options.modifiers) ==
                        null
                                ? void 0
                                : _b2.prevent
                )
                        ev.preventDefault();
                if (
                        (_c = options == null ? void 0 : options.modifiers) ==
                        null
                                ? void 0
                                : _c.stop
                )
        ...
        function onMove(ev) {
                ...
                if (
                        ...
                        ((_d =
                                options == null
                                        ? void 0
                                        : options.distanceThreshold) != null
                                ? _d
                                : DEFAULT_THRESHOLD)
                )
                        clear();
        ...
        const listenerOptions = {
                capture:
                        (_a = options == null ? void 0 : options.modifiers) ==
                        null
                                ? void 0
                                : _a.capture,
                once:
                        (_b = options == null ? void 0 : options.modifiers) ==
                        null
                                ? void 0
                                : _b.once,
        };
...
function onStartTyping(callback, options = {}) {
        ...
        if (document2)
                useEventListener(document2, 'keydown', keydown, {
                        passive: true,
                });
}
...
function useBase64(target, options) {
        ...
        function execute() {
                ...
                promise.value = new Promise((resolve, reject) => {
                        try {
                                ...
                                if (_target == null) {
                                        ...
                                        _target instanceof HTMLCanvasElement
                                ) {
                                        resolve(
                                                _target.toDataURL(
                                                        options == null
                                        ...
                                        _target instanceof HTMLImageElement
                                ) {
                ...
                promise.value.then(res => {
                        base64.value =
                                (options == null ? void 0 : options.dataUrl) ===
                                false
...
function useBreakpoints(breakpoints, options = {}) {
        ...
        const greaterOrEqual = k => {
                return useMediaQuery(
                        () => `(min-width: ${getValue2(k)})`,
                        options,
                );
        };
        const smallerOrEqual = k => {
                return useMediaQuery(
                        () => `(max-width: ${getValue2(k)})`,
                        options,
                );
        };
        ...
        return Object.assign(shortcutMethods, {
                ...
                isInBetween(a, b) {
                        return (
                                match('min', getValue2(a)) &&
                                match('max', getValue2(b, -0.1))
                        );
                },
                current,
                active() {
...
function usePermission(permissionDesc, options = {}) {
        ...
        const update = () => {
                ...
                state.value =
                        (_b =
                                (_a = permissionStatus.value) == null
                                        ? void 0
                                        : _a.state) != null
                                ? _b
                                : 'prompt';
                ...
                if (!permissionStatus.value) {
                        try {
                                permissionStatus.value =
                                        await navigator2.permissions.query(
                                                desc,
                                        );
                        } catch (e) {
...
function useClipboard(options = {}) {
        ...
        const isSupported = computed(
                () => isClipboardApiSupported.value || legacy,
        );
        ...
        async function updateText() {
                ...
                if (!useLegacy) {
                        try {
                                text.value =
                                        await navigator2.clipboard.readText();
                        } catch (e) {
                                useLegacy = true;
                        }
                }
...
function useCountdown(initialCountdown, options) {
        ...
        const intervalController = useIntervalFn(
                () => {
                        ...
                        (_a2 = options == null ? void 0 : options.onTick) ==
                        null
                                ? void 0
                                : _a2.call(options);
                ...
                (_a = options == null ? void 0 : options.interval) != null
                        ? _a
                        : 1e3,
                {
                        immediate:
...
function useCssVar(prop, target, options = {}) {
        ...
        const elRef = computed(() => {
                ...
                return (
                        unrefElement(target) ||
                        ((_a = window2 == null ? void 0 : window2.document) ==
                        null
                                ? void 0
                                : _a.documentElement)
                );
...
function useCycleList(list, options) {
        ...
        const index = computed({
                get() {
                        ...
                        let index2 = (
                                options == null ? void 0 : options.getIndexOf
                        )
...
function useManualRefHistory(source, options = {}) {
        ...
        const commit = () => {
                ...
                if (
                        options.capacity &&
                        undoStack.value.length > options.capacity
                )
...
function useDebouncedRefHistory(source, options = {}) {
        const filter = options.debounce
                ? debounceFilter(options.debounce)
                : void 0;
...
function useDevicesList(options = {}) {
        ...
        async function update() {
                if (!isSupported.value) return;
                devices.value =
                        await navigator2.mediaDevices.enumerateDevices();
        ...
        async function ensurePermissions() {
                ...
                if (state.value !== 'granted') {
                        ...
                        try {
                                stream =
                                        await navigator2.mediaDevices.getUserMedia(
                                                constraints,
                                        );
                        } catch (e) {
                                stream = null;
...
function useDisplayMedia(options = {}) {
        ...
        async function _start() {
                ...
                stream.value =
                        await navigator2.mediaDevices.getDisplayMedia(
                                constraint,
                        );
                (_a2 = stream.value) == null
                        ? void 0
                        : _a2.getTracks().forEach(t =>
                                  useEventListener(t, 'ended', stop, {
                                          passive: true,
                                  }),
                          );
                return stream.value;
...
function useDropZone(target, options = {}) {
        ...
        if (isClient) {
                ...
                const preventDefaultForUnhandled =
                        (_b = _options.preventDefaultForUnhandled) != null
                                ? _b
                                : false;
                ...
                const handleDragEvent = (event, eventType) => {
                        ...
                        isValid =
                                (_b2 =
                                        ...
                                        checkValidity(dataTransferItemList)) !=
                                null
                                        ? _b2
                                        : false;
...
function useFetch(url, ...args) {
        ...
        const execute = async (throwOnFailed = false) => {
                ...
                if (options.beforeFetch)
                        Object.assign(
                                context,
                                await options.beforeFetch(context),
                        );
                if (isCanceled || !fetch) {
                        loading(false);
...
function useFileSystemAccess(options = {}) {
        ...
        const fileName = computed(() => {
                var _a, _b;
                return (_b = (_a = file.value) == null ? void 0 : _a.name) !=
                        null
                        ? _b
                        : '';
        });
        const fileMIME = computed(() => {
                var _a, _b;
                return (_b = (_a = file.value) == null ? void 0 : _a.type) !=
                        null
                        ? _b
                        : '';
        });
        const fileSize = computed(() => {
                var _a, _b;
                return (_b = (_a = file.value) == null ? void 0 : _a.size) !=
                        null
                        ? _b
                        : 0;
        });
        const fileLastModified = computed(() => {
                var _a, _b;
                return (_b =
                        (_a = file.value) == null ? void 0 : _a.lastModified) !=
                        null
                        ? _b
                        : 0;
        });
        ...
        async function updateData() {
                ...
                if (type === 'Text')
                        data.value = await ((_a = file.value) == null
                                ? void 0
                                : _a.text());
...
function useFps(options) {
        ...
        const every =
                (_a = options == null ? void 0 : options.every) != null
                        ? _a
                        : 10;
...
function useFullscreen(target, options = {}) {
        const {document: document2 = defaultDocument, autoExit = false} =
                options;
        ...
        const isElementFullScreen = () => {
                if (fullscreenEnabled.value) {
                        if (
                                document2 &&
                                document2[fullscreenEnabled.value] != null
                        ) {
        ...
        async function exit() {
                ...
                if (exitMethod.value) {
                        if (
                                (document2 == null
                                        ? void 0
                                        : document2[exitMethod.value]) != null
                        ) {
        ...
        async function enter() {
                ...
                if (
                        ...
                        (target2 == null
                                ? void 0
                                : target2[requestMethod.value]) != null
                ) {
...
function useGamepad(options = {}) {
        ...
        const updateGamepadState = () => {
                const _gamepads =
                        (navigator2 == null
                                ? void 0
                                : navigator2.getGamepads()) || [];
                for (const gamepad of _gamepads) {
                        if (gamepad && gamepads.value[gamepad.index])
                                gamepads.value[gamepad.index] =
                                        stateFromGamepad(gamepad);
                }
        };
        ...
        const onGamepadDisconnected = gamepad => {
                gamepads.value = gamepads.value.filter(
                        x => x.index !== gamepad.index,
                );
...
function useScroll(element, options = {}) {
        ...
        function scrollTo(_x, _y) {
                ...
                const scrollContainer =
                        ((_d = _element == null ? void 0 : _element.document) ==
                        null
                                ? void 0
                                : _d.documentElement) ||
                        (_element == null
        ...
        const onScrollEndDebounced = useDebounceFn(
                onScrollEnd,
                throttle + idle,
        );
        const setArrivedState = target => {
                ...
                if (!window2) return;
                const el =
                        ((_a = target == null ? void 0 : target.document) ==
                        null
                                ? void 0
                                : _a.documentElement) ||
                        (target == null ? void 0 : target.documentElement) ||
                        unrefElement(target);
                const {display, flexDirection, direction} =
                        getComputedStyle(el);
                ...
                const left =
                        Math.abs(scrollLeft * directionMultipler) <=
                        (offset.left || 0);
                const right =
                        Math.abs(scrollLeft * directionMultipler) +
                                el.clientWidth >=
...
function useMediaControls(target, options = {}) {
        ...
        watchEffect(() => {
                ...
                textTracks.forEach(
                        (
                                {default: isDefault, kind, label, src, srcLang},
                                i,
                        ) => {
...
function useMousePressed(options = {}) {
        ...
        const onPressed = srcType => event => {
                ...
                (_a = options.onPressed) == null
                        ? void 0
                        : _a.call(options, event);
        };
        const onReleased = event => {
                var _a;
                pressed.value = false;
                sourceType.value = null;
                (_a = options.onReleased) == null
                        ? void 0
                        : _a.call(options, event);
        };
...
function useParallax(target, options = {}) {
        ...
        const roll = computed(() => {
                if (source.value === 'deviceOrientation') {
                        ...
                        const value =
                                -(y.value - height.value / 2) / height.value;
...
function usePointerLock(target, options = {}) {
                ...
                useEventListener(
                        ...
                        () => {
                                ...
                                const currentElement =
                                        (_a = document2.pointerLockElement) !=
                                        null
                                                ? _a
                                                : element.value;
                                if (
        ...
        async function lock(e) {
                ...
                triggerElement.value =
                        e instanceof Event ? e.currentTarget : null;
                targetElement =
                        e instanceof Event
                                ? (_a = unrefElement(target)) != null
                                        ? _a
...
function usePointerSwipe(target, options = {}) {
        ...
        const isThresholdExceeded = computed(
                () =>
                        max(abs(distanceX.value), abs(distanceY.value)) >=
                        threshold,
        );
        ...
        tryOnMounted(() => {
                ...
                (_b = (_a = targetRef.value) == null ? void 0 : _a.style) ==
                null
                        ? void 0
                        : _b.setProperty('touch-action', 'none');
                if (disableTextSelect) {
                        (_d =
                                (_c = targetRef.value) == null
                                        ? void 0
                                        : _c.style) == null
                                ? void 0
                                : _d.setProperty('-webkit-user-select', 'none');
                        (_f =
                                (_e = targetRef.value) == null
                                        ? void 0
                                        : _e.style) == null
                                ? void 0
                                : _f.setProperty('-ms-user-select', 'none');
                        (_h =
                                (_g = targetRef.value) == null
                                        ? void 0
                                        : _g.style) == null
                                ? void 0
...
function useScriptTag(src, onLoaded = noop, options = {}) {
        ...
        const loadScript = waitForScriptLoad =>
                new Promise((resolve, reject) => {
                        ...
                        let el = document2.querySelector(
        ...
        const unload = () => {
                ...
                const el = document2.querySelector(
                        `script[src="${toValue(src)}"]`,
                );
...
function checkOverflowScroll(ele) {
        ...
        if (
                ...
                (style.overflowX === 'auto' &&
                        ele.clientWidth < ele.scrollWidth) ||
...
function useSorted(...args) {
        ...
        if (args.length === 2) {
                if (typeof args[1] === 'object') {
                        options = args[1];
                        compareFn =
                                (_a = options.compareFn) != null
                                        ? _a
                                        : defaultCompare;
                } else {
                        compareFn =
                                (_b = args[1]) != null ? _b : defaultCompare;
                }
        } else if (args.length > 2) {
...
function useStepper(steps, initialStep) {
        ...
        const isLast = computed(
                () => index.value === stepNames.value.length - 1,
        );
                        ...
                        if (rawValue == null) {
                                ...
                                if (writeDefaults && rawInit !== null)
                                        await storage.setItem(
                                                key,
                                                await serializer.write(rawInit),
                                        );
                        } else if (mergeDefaults) {
                                const value = await serializer.read(rawValue);
                                if (typeof mergeDefaults === 'function')
                                        data.value = mergeDefaults(
                                                value,
                                                rawInit,
                                        );
                                else if (
...
function useStyleTag(css, options = {}) {
        ...
        const load = () => {
                if (!document2) return;
                const el =
                        document2.getElementById(id) ||
                        document2.createElement('style');
                if (!el.isConnected) {
                        el.id = id;
                ...
                useEventListener(
                        ...
                        e => {
                                ...
                                if (
                                        ...
                                        Math.abs(diffX.value) >
                                                Math.abs(diffY.value)
                                )
                                        e.preventDefault();
                                if (
                                        !isSwiping.value &&
...
function useTextareaAutosize(options = {}) {
        ...
        const input = toRef2(
                (_a = options == null ? void 0 : options.input) != null
                        ? _a
                        : '',
        );
        const styleProp =
        ...
        watch(textareaScrollHeight, () => {
                var _a2;
                return (_a2 = options == null ? void 0 : options.onResize) ==
                        null
                        ? void 0
                        : _a2.call(options);
        });
        ...
        if (options == null ? void 0 : options.watch)
                watch(options.watch, triggerResize, {
                        immediate: true,
                        deep: true,
                });
        return {
...
function useTimeAgo(time, options = {}) {
        const {controls: exposeControls = false, updateInterval = 3e4} =
                options;
...
function formatTimeAgo(from, options = {}, now2 = Date.now()) {
        ...
        if (typeof max === 'string') {
                const unitMax =
                        (_a = units.find(i => i.name === max)) == null
                                ? void 0
                                : _a.max;
...
function useTitle(newTitle = null, options = {}) {
        ...
        const originalTitle =
                (_a = document2 == null ? void 0 : document2.title) != null
                        ? _a
                        : '';
        const title = toRef2(
                (_b =
        ...
        if (
                ...
                useMutationObserver(
                        (_c = document2.head) == null
                                ? void 0
                                : _c.querySelector('title'),
                        () => {
                                if (
                                        document2 &&
                                        document2.title !== title.value
                                )
...
function useTransition(source, options = {}) {
        ...
        watch(
                ...
                async to => {
                        ...
                        const toVal = Array.isArray(to)
                                ? to.map(toValue)
                                : toValue(to);
                        (_a = options.onStarted) == null
                                ? void 0
                                : _a.call(options);
...
function useVibrate(options) {
        ...
        const isSupported = useSupported(
                () =>
                        typeof navigator2 !== 'undefined' &&
                        'vibrate' in navigator2,
        );
...
function createComputedTotalSize(itemSize, source) {
        return computed(() => {
                ...
                return source.value.reduce(
                        (sum, _, index) => sum + itemSize(index),
                        0,
                );
        });
}
...
function createScrollTo(type, calculateRange, getDistance, containerRef) {
        return index => {
                if (containerRef.value) {
                        containerRef.value[
                                scrollToDictionaryForElementScrollKey[type]
                        ] = getDistance(index);
                        calculateRange();
                }
        };
...
function useVerticalVirtualList(options, list) {
        ...
        const getViewCapacity = createGetViewCapacity(
                state,
                source,
                itemHeight,
        );
...
function useWebWorker(arg0, workerOptions, options) {
        const {window: window2 = defaultWindow} =
                options != null ? options : {};
        const data = ref(null);
        ...
        const update = () => {
                if (window2) {
                        if (type === 'outer') {
                                ...
                                width.value =
                                        window2.document.documentElement.clientWidth;
                                height.value =
                                        window2.document.documentElement.clientHeight;
                        }
                }
        };
        update();
...
//# sourceMappingURL=chunk-BHALWE2C.js.map
