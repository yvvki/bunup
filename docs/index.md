...
**Bunup** delivers instant builds by design. With Bun's native speed and [Bunup's own high-performance dts bundler](https://github.com/bunup/typeroll), cold starts and rebuilds are lightning fast, even in monorepos. See [benchmarks](https://gugustinette.github.io/bundler-benchmark/).
